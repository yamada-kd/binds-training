...
**Python**
^^^
プログラミング言語 [Python](https://www.python.org/) の利用方法を紹介します．Python には機械学習法を実装するための便利なライブラリを利用することができるデータ科学を利用した解析に便利な言語です．
