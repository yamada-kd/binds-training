...
# #2. <font color="Crimson">Hugging Face 入門</font>
# 

# ##2-1. <font color="Crimson">Hugging Face とは</font>

# ###2-1-1. <font color="Crimson">トランスフォーマー</font>
...
# 
# <img src="https://drive.google.com/uc?id=1KdR10dTZosfyHOlnu8UhlRlogRj0FuSg" width="30%">
# 
...
# <font color="Crimson">(9｀･ω･)9 ｡oO(実用上，配列を入力にして配列を返す構造とだけ覚えておけば問題はないと思います．)</font>

# ###2-1-2. <font color="Crimson">できること</font>
...
# ###2-2-2. <font color="Crimson">特徴抽出</font>
...
# <font color="Crimson">(9｀･ω･)9 ｡oO(例えば，BERT を使うと各トークンが768次元のベクトルでトークン数個からなる要素のベクトルが出力されます．)</font>

# ###2-2-3. <font color="Crimson">ゼロショット文章分類</font>
...
# <font color="Crimson">(9｀･ω･)9 ｡oO(ゼロショット分類では，例えば，馬を入力にして猫とか犬とかのラベルそのものを予測されるのではなくて猫および犬ベクトルを予測させどちらに近いかを予測させることができます．そろそろマシンパワー的にきついかもしれませんね．)</font>

# ###2-2-4. <font color="Crimson">文章生成</font>
...
# ###2-2-5. <font color="Crimson">穴埋め</font>
...
# ###2-2-6. <font color="Crimson">固有表現抽出</font>
...
# ###2-2-7. <font color="Crimson">質問応答</font>
...
# ###2-2-8. <font color="Crimson">要約</font>
...
# ###2-2-9. <font color="Crimson">翻訳</font>
...
# ##2-3. <font color="Crimson">応用的な使い方</font>

# ###2-3-1. <font color="Crimson">他のモデルの利用</font>
...
# ###2-3-2. <font color="Crimson">日本語の解析</font>
...
# <font color="Crimson">(9｀･ω･)9 ｡oO(これをインストールしないで使ったらインストールしろってメッセージが出たからインストールしました．)</font>
...
# ###2-3-3. <font color="Crimson">モデルの設定変更</font>
...
# ###2-3-3. <font color="Crimson">ファインチューニング</font>
