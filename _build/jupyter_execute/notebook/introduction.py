...
# 教師あり学習法では，入力データとそれに紐づいた教師データの組み合わせ利用します．例えば，画像認識の問題を考えるとすると，「ゴリラが写っている画像」と共に「ゴリラ」という情報を用います．この場合，「ゴリラが写っている画像」が成長させたい人工知能に入力するデータで，「ゴリラ」という情報は人工知能にこの画像にはゴリラが写っていることを教えるための教師（supervisor）データです．この教師データはラベル，正解，ターゲットデータ等とも呼ばることがあります．
# 
