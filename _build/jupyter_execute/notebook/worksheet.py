...
# 配点は各問題についてそれぞれ 10 点です．プログラムは問題通りの出力を再現できたとしても意図通りかけていない場合があり採点の基準が必要であるため，採点者は以下のような採点基準で点数をつけます．
# 
# | 点 | 基準 |
# | --- | --- |
# | 10 | この解答が良い評価を得ないのであれば全ての採点を拒否する． |
# | 9 | この解答が絶対に良い評価得るべきである． |
# | 8 | この解答は良い評価を得るべきである． |
...
# | 2 | この解答に絶対に良い評価を与えるべきではない． |
# | 1 | この解答が良い評価を得るのだとしたら全ての採点を拒否する． |
# | 0 | 解答がないため採点できない． |
# 
